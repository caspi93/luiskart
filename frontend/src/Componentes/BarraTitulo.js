            ...
            <nav className="BarraTitulo navbar navbar-expand-lg navbar-light">
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form className="form-inline">
                        <button className="btn btn-primary my-2 my-sm-0" type="button" onClick={this.props.onClickNuevo} hidden={this.props.oculto}><FontAwesomeIcon icon="plus" /> Nuevo</button>
                    </form>
                </div>
            </nav>
        )
